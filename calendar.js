...
function Calendar(isHijr,year,month,firstDay,lang,theme,tmout){
	...
	createAboutModal=function(){
		...
		aboutTitleElm=createElm('p','w3-large');aboutDateElm=createElm('p','w3-large');aboutElm.id='ZulNsAbout';
	...
	if(typeof isHijr!='boolean')isHijr=true;
	dispDate=isHijr?hdate:gdate;
	firstDay=HijriDate.int(firstDay,0)%7;
...
/*
#1 color = #6495ED #93c847;
#2 color = #191970 #65b037;
*/

Object.defineProperty(Calendar,'themes',{value:['light-blue','teal']});
Object.defineProperty(Calendar,'lang',{value:'id',writable:true});
...
Calendar.language['id']={
	...
	monthShortNames:["Jan","Peb","Mar","Apr","Mei","Jun","Jul","Agu","Sep","Okt","Nop","Des"],
	weekdayNames:["Ahad","Senin","Selasa","Rabu","Kamis","Jum'at","Sabtu"],
	weekdayShortNames:["Ahd","Sen","Sel","Rab","Kam","Jum","Sab"],
